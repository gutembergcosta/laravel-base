            ...
            <div class="vertical-align-middle">
                <div class="auth-box ">
                    <div class="content">
                        ...
                        <form id="form-login" class="form-auth-small" action="{{ route('entrar') }}">
                            ...
                            <div class="bottom">
                                <span class="helper-text"><i class="fa fa-lock"></i> <a href="{{ route('nova-senha.solicitar') }}">Esqueci minha senha</a></span>
                            </div>
                        </form>
